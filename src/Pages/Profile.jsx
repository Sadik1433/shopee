...
const Profile = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        phone: "",
        address: "",
        profileImage: "https://res.cloudinary.com/dnarxeess/image/upload/v1746433101/IMG_20250505_134704_ji1fo4.png",
    });
    ...
    useEffect(() => {
        if (!activeUser) {
            ...
            setFormData({
                ...
                profileImage: activeUser.profileImage || "https://res.cloudinary.com/dnarxeess/image/upload/v1746433101/IMG_20250505_134704_ji1fo4.png",
            });
        }
    }, [activeUser, navigate]);
        ...
        <div className="min-h-screen w-[1200px]  bg-[var(--bg-color)] px-4 py-24 flex">
            <div className="w-full flex flex-col ">
                <div className="mb-8 flex items-center justify-between">
                    ...
                    <h1 className="text-3xl font-bold text-[var(--heading-color)]">My Profile</h1>
                    <button
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-1 flex flex-col gap-6">
                        <div className="bg-[var(--card-color)] border border-[var(--border-color)] rounded-3xl p-8 flex flex-col items-center shadow-xl backdrop-blur-sm">
                            ...
                            <h2 className="mt-6 text-2xl font-bold text-[var(--text-color)]">{formData.username}</h2>
                    ...
                    <div className="lg:col-span-2">
                        <div className="bg-[var(--card-color)] border border-[var(--border-color)] rounded-3xl p-8 shadow-xl backdrop-blur-sm flex flex-col gap-6">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="text-xs font-bold text-[var(--text-secondary)] uppercase tracking-wider ml-1">Phone Number</label>
                                    <div className="relative">
